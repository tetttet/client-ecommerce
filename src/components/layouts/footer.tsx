...
const footerSections = [
  ...
  {
    title: "Campaigns",
    links: ["Campaigns", "Shopping loans", "Elite membership", "Gift ideas"],
  },
  {
    title: "Sellers",
    links: ["Sell on Trendyol", "Basic concepts", "Trendyol Academy"],
  },
  {
    title: "Help",
    links: [
          ...
          <div className="mt-4 flex flex-col gap-5 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-6">
              {bottomLinks.map((link) => (
                <span
                  key={link}
                  className="cursor-pointer text-[12px] text-[#bdbdbd] transition hover:text-white"
                >
                  {link}
                </span>
              ))}
